...
```{r}
#| label: plot-non-linear-temp-death
#| fig-height: 5
#| fig-width: 5
...
```{r}
#| label: backtransform-phase
cat(
  "Mean phase = ",
  round(invyrfraction(0.6952055 / (2 * pi), type = "monthly", text = F), 2),
  " months.\n",
  sep = ""
)
cat(
  "Lower 95% interval = ",
  round(invyrfraction(0.5732958 / (2 * pi), type = "monthly", text = F), 2),
  " months.\n",
  sep = ""
)
cat(
  "Upper 95% interval = ",
  round(invyrfraction(0.8216251 / (2 * pi), type = "monthly", text = F), 2),
  " months.\n",
  sep = ""
)
```
